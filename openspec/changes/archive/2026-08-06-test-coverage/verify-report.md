...
**Version**: delta spec `openspec/changes/2026-08-06-test-coverage/specs/test-coverage/spec.md`
...
**sdd-archive** — change is fully implemented, verified, and spec-compliant. Archive will move the change folder to `openspec/changes/archive/` and merge the delta spec into main specs.
