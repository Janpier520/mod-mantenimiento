...
**Version**: delta spec `openspec/changes/archive/2026-08-07-project-readme/specs/project-readme/spec.md` (synced to main spec `openspec/specs/project-readme.md`)
